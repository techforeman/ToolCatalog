...
namespace ToolCatalog.Migrations
{
    ...
    [Migration("20180412091318_Initial")]
            ...
            modelBuilder.Entity("ToolCatalog.Models.Tool", b =>
                {
                    ...
                    b.Property<int?>("SSCUnitIdSSCUnit");
            ...
            modelBuilder.Entity("ToolCatalog.Models.Tool", b =>
                {
                    ...
                    b.HasOne("ToolCatalog.Models.SSCUnit")
                        .WithMany("Tools")
                        .HasForeignKey("SSCUnitIdSSCUnit");
                });
        }
    }
}
